...
class AffindaAPI(AffindaAPIOperationsMixin):
    ...
    def _send_request(
        ...
        **kwargs: Any
        ...
        >>> from affinda._rest import build_get_all_resumes_request
        >>> request = build_get_all_resumes_request(limit=limit, offset=offset, **kwargs)
        <HttpRequest [GET], url: '/resumes'>
