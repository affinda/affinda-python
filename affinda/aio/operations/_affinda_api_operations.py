...
class AffindaAPIOperationsMixin:  # pylint: disable=too-many-public-methods
    ...
    get_data_field_for_collection.metadata = {"url": "/v3/collections/{identifier}/fields/{datapoint_identifier}"}  # type: ignore
    ...
    update_data_field_for_collection.metadata = {"url": "/v3/collections/{identifier}/fields/{datapoint_identifier}"}  # type: ignore
    ...
    async def create_annotation(
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[Optional[_models.AnnotationWithValidationResults]]
    ...
    async def list_mapping_data_sources(
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[_models.Paths11QdcofV3MappingDataSourcesGetResponses200ContentApplicationJsonSchema]
    ...
    async def list_mappings(
        ...
        **kwargs: Any,
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[_models.Paths1Dpvb2PV3MappingsGetResponses200ContentApplicationJsonSchema]
    ...
    async def get_all_api_users(
        ...
        cls = kwargs.pop(
            "cls", None
        )  # type: ClsType[_models.Paths26Civ0V3ApiUsersGetResponses200ContentApplicationJsonSchema]
    ...
    async def get_all_index_documents(
        self, name: str, offset: Optional[int] = None, limit: Optional[int] = 300, **kwargs: Any
