...
try:
    ...
    from ._models import Paths11QdcofV3MappingDataSourcesGetResponses200ContentApplicationJsonSchema  # type: ignore
    ...
    from ._models import Paths1UmoszuV3MappingDataSourcesGetResponses200ContentApplicationJsonSchemaAllof1  # type: ignore
