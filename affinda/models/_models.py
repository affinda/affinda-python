# coding=utf-8
# --------------------------------------------------------------------------
# Code generated by Microsoft (R) AutoRest Code Generator (autorest: 3.10.4, generator: @autorest/python@5.16.0)
...
class Collection(msrest.serialization.Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.auto_refresh_validation_results = kwargs.get("auto_refresh_validation_results", True)
...
class DocumentMeta(msrest.serialization.Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.archived_by = kwargs.get("archived_by", None)
...
class DocumentMetaCollection(msrest.serialization.Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.auto_refresh_validation_results = kwargs.get("auto_refresh_validation_results", None)
