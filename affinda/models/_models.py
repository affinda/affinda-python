# coding=utf-8
# --------------------------------------------------------------------------
# Code generated by Microsoft (R) AutoRest Code Generator (autorest: 3.9.1, generator: @autorest/python@5.16.0)
...
class Components17Ashz6SchemasInvoicePropertiesMetaAllof1(msrest.serialization.Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.client_verified_dt = kwargs.get("client_verified_dt", None)
