...
class Annotation(msrest.serialization.Model):
    ...
    _attribute_map = {
        ...
        "classification_confidence": {"key": "classification_confidence", "type": "float"},
        "text_extraction_confidence": {"key": "text_extraction_confidence", "type": "float"},
    ...
    def __init__(self, **kwargs):
        ...
        :paramtype raw: str
        :keyword confidence: Required. Combined confidence from the model confidence and the OCR
         confidence.
        :paramtype confidence: float
        :keyword classification_confidence: Required. The AI model confidence.
        :paramtype classification_confidence: float
        :keyword text_extraction_confidence: Required. The OCR confidence.
...
class EnumAnnotationSerializer(Annotation):
    ...
    def __init__(self, **kwargs):
        ...
        :paramtype parsed: str
        """
        super(EnumAnnotationSerializer, self).__init__(**kwargs)
        self.parsed = kwargs.get("parsed", None)
