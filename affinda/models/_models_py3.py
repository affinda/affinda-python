...
class InvoiceDataTablesItem(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        parsed: Optional[List["_models.InvoiceDataTablesPropertiesItemsItem"]] = None,
        **kwargs,
    ):
        """
        :keyword parsed:
...
class Paths1TvfqeiV3IndexPostResponses201ContentApplicationJsonSchema(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        name: Optional[str] = None,
        document_type: Optional[Union[str, "_models.Enum21"]] = None,
        **kwargs,
    ):
        """
        :keyword name:
        :paramtype name: str
        :keyword document_type: Known values are: "resumes", "job_descriptions".
        :paramtype document_type: str or ~affinda.models.Enum21
        """
