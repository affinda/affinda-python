...
class Meta(msrest.serialization.Model):
    ...
    :param ready: Required. If true, the document has finished processing. Particularly useful if
     ...
     stop polling.
    :type ready: bool
    :param ready_dt: Required. The datetime when the document was ready.
...
class RedactedDocument(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        data: Optional["RedactedDocumentData"] = None,
...
class RedactedDocumentData(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        redacted_pdf: Optional[str] = None,
        **kwargs
    ):
...
class ReformattedDocument(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        data: Optional["ReformattedDocumentData"] = None,
        meta: Optional["Meta"] = None,
        error: Optional["Error"] = None,
        **kwargs
    ):
...
class ReformattedDocumentData(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        reformatted_file: Optional[str] = None,
        **kwargs
    ):
...
class ResumeData(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        skills_details: Optional[List["ResumeDataSkillsDetailsItem"]] = None,
        ...
        **kwargs
        ...
        self.skills = skills
        self.skills_details = skills_details
...
class ResumeDataSkillsDetailsItem(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        sources: Optional[List["ResumeDataSkillsDetailsPropertiesItemsItem"]] = None,
        **kwargs
    ):
...
class User(msrest.serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        redacted_document_count: Optional[int] = None,
        reformatted_resume_count: Optional[int] = None,
        parsing_credits: Optional[int] = None,
        redaction_credits: Optional[int] = None,
        reformatting_credits: Optional[int] = None,
        **kwargs
    ):
        super(User, self).__init__(**kwargs)
        self.document_count = document_count
        self.redacted_document_count = redacted_document_count
        self.reformatted_resume_count = reformatted_resume_count
        self.parsing_credits = parsing_credits
        self.redaction_credits = redaction_credits
        self.reformatting_credits = reformatting_credits
