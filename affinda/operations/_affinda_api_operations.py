...
def build_create_document_from_data_request(
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/v3/documents/create_from_data")
...
class AffindaAPIOperationsMixin(object):  # pylint: disable=too-many-public-methods
    ...
    create_document_from_data.metadata = {"url": "/v3/documents/create_from_data"}  # type: ignore
    ...
    def list_mappings(
        ...
        **kwargs,  # type: Any
        ...
        :param mapping_data_source: Data source's identifier.
