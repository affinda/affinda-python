...
def build_get_resume_request(
    ...
    **kwargs  # type: Any
    ...
    format = kwargs.pop('format', _params.pop('format', None))  # type: Optional[Union[str, "_models.Enum1"]]
...
def build_get_all_indexes_request(
    **kwargs  # type: Any
    ...
    offset = kwargs.pop('offset', _params.pop('offset', None))  # type: Optional[int]
    limit = kwargs.pop('limit', _params.pop('limit', 300))  # type: Optional[int]
    document_type = kwargs.pop('document_type', _params.pop('document_type', None))  # type: Optional[Union[str, "_models.Enum4"]]
    accept = _headers.pop('Accept', "application/json")
...
class AffindaAPIOperationsMixin(object):  # pylint: disable=too-many-public-methods
    ...
    def get_resume(
        self,
        identifier,  # type: str
        format=None,  # type: Optional[Union[str, "_models.Enum1"]]
        **kwargs,  # type: Any
    ):
        # type: (...) -> _models.Resume
        ...
        :type format: str or ~affinda.models.Enum1
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Resume, or the result of cls(response)
        :rtype: ~affinda.models.Resume
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_all_indexes(
        ...
        offset=None,  # type: Optional[int]
        limit=300,  # type: Optional[int]
        document_type=None,  # type: Optional[Union[str, "_models.Enum4"]]
        **kwargs,  # type: Any
    ):
        ...
        :type document_type: str or ~affinda.models.Enum4
        :keyword callable cls: A custom type or function that will be passed the direct response
